...
public class EditContactActivity extends AppCompatActivity implements Observer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Contact contact = contact_list_controller.getContact(pos);
    ...
    public void saveContact(View view) {
        ...
        boolean success = contact_list_controller.editContact(contact_controller.getContact(), updated_contact, context);
        if (!success){
            return;
        }
    ...
    public void deleteContact(View view) {
        contact_list_controller.deleteContact(contact_controller.getContact(), context);
